...
var Keyboard = function (_PureComponent) {
	...
	_createClass(Keyboard, [{
		...
		value: function render() {
			...
			var backSpace = this.props.backSpace ? this.props.backSpace : _react2.default.createElement(_BackspaceIcon2.default, null);
			var shift = this.props.shift ? this.props.shift : _react2.default.createElement(_ShiftIcon2.default, null);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					inputNode.dataset.type === 'email' || inputNode.type === 'email' ? _react2.default.createElement(_KeyboardButton2.default, {
						value: '@',
...
Keyboard.propTypes = {
	...
	backSpace: _react.PropTypes.object,
	shift: _react.PropTypes.object,
	space: _react.PropTypes.string
};
